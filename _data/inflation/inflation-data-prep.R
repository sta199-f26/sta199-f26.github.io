...
us_inflation_raw <- read_csv(
  "_data/inflation/OECD.SDD.TPS,DSD_PRICES@DF_PRICES_ALL,1.0,filtered,2026-09-17 05-37-26.csv"
)
...
write_csv(us_inflation, "_data/inflation/us-inflation.csv")
write_csv(cpi_expenditures, "_data/inflation/cpi-expenditures.csv")

write_csv(us_inflation, "hw/data/us-inflation.csv")
write_csv(cpi_expenditures, "hw/data/cpi-expenditures.csv")

# check

read_csv("_data/inflation/us-inflation.csv") |> names()
read_csv("_data/inflation/us-inflation.csv") |> distinct(year)
read_csv("_data/inflation/cpi-expenditures.csv") |> names()
