...
- If you have received an email from Dr. Knox about missing labs, HWs, commits, files on GitHub or Gradescope:
  1. Don't panic -- these emails are just to make sure you don't repeatedly make the same errors throughout assignments
  2. If you're not sure how to address the issues, please write back ASAP so we can help you!
  3. If you know how to address it, make sure you do in your following assignment!
...
-   If you haven't yet done so, click Pull to get today's application exercise file: `ae-04-taxes-join.qmd`.
