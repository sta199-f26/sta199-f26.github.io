...
subtitle: Lecture 6
author: "Dr. Mine Çetinkaya-Rundel and Josh Lim"
date: 2026-09-14
format: 
  revealjs: 
...
![](images/06/joshsummer.png){height="550" fig-align="center" fig-alt="Photo of Josh's STA 199 class from Summer 2026."}

## Hmm, Josh have I seen you somewhere before?

:::: columns
::: {.column width="50%"}
![](images/06/dukechinesedance.jpg){height="260" fig-align="center" fig-alt="Josh at a Duke Chinese dance event."}

![](images/06/dukegym.JPEG){height="260" fig-align="center" fig-alt="Josh with Duke Gymnastics."}
:::

::: {.column width="50%"}
![](images/06/dukevolley.jpg){height="540" fig-align="center" fig-alt="Josh playing volleyball at Duke."}
:::
::::
