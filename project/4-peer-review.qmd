...
```{r}
#| message: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1EFjL1GgiOGEbR79JrDoNoUwoeJi6y3Wjn8XjHCa10mE/edit?usp=sharing", sheet = paste0("lab_", 1))
...
```{r}
#| message: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1EFjL1GgiOGEbR79JrDoNoUwoeJi6y3Wjn8XjHCa10mE/edit?usp=sharing", sheet = paste0("lab_", 3))
make_pairing_table(teams)
```
...
```{r}
#| message: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1EFjL1GgiOGEbR79JrDoNoUwoeJi6y3Wjn8XjHCa10mE/edit?usp=sharing", sheet = paste0("lab_", 4))
make_pairing_table(teams)
```
...
```{r}
#| message: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1EFjL1GgiOGEbR79JrDoNoUwoeJi6y3Wjn8XjHCa10mE/edit?usp=sharing", sheet = paste0("lab_", 5))
make_pairing_table(teams)
```
...
```{r}
#| message: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1EFjL1GgiOGEbR79JrDoNoUwoeJi6y3Wjn8XjHCa10mE/edit?usp=sharing", sheet = paste0("lab_", 6))
make_pairing_table(teams)
```
...
```{r}
#| message: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1EFjL1GgiOGEbR79JrDoNoUwoeJi6y3Wjn8XjHCa10mE/edit?usp=sharing", sheet = paste0("lab_", 7))
make_pairing_table(teams)
```
...
```{r}
#| message: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1EFjL1GgiOGEbR79JrDoNoUwoeJi6y3Wjn8XjHCa10mE/edit?usp=sharing", sheet = paste0("lab_", 8))
make_pairing_table(teams)
```
...
```{r}
#| message: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1EFjL1GgiOGEbR79JrDoNoUwoeJi6y3Wjn8XjHCa10mE/edit?usp=sharing", sheet = paste0("lab_", 9))
make_pairing_table(teams)
```
...
```{r}
#| message: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1EFjL1GgiOGEbR79JrDoNoUwoeJi6y3Wjn8XjHCa10mE/edit?usp=sharing", sheet = paste0("lab_", 11))
make_pairing_table(teams)
```
:::
