...
You will provide your feedback in the form of GitHub issues in your partner team's GitHub repo.
...
-   Then,
    ...
    -   1-2 team members clone the team's project and render it to check for reproducibility.

    -   All team members open the team's project in their browser and start reading through the project draft.
...
make_pairing_table <- function(df) {
  df |>
    mutate(
      team_to_review_1 = paste0("[", team_to_review_1, "](", url_1, ")")
    ) |>
...
#| message: false
teams <- read_sheet(
  "https://docs.google.com/spreadsheets/d/1EFjL1GgiOGEbR79JrDoNoUwoeJi6y3Wjn8XjHCa10mE/edit?usp=sharing",
  sheet = paste0("lab_", 1)
)
...
Peer reviews will be graded on the extent to which they comprehensively and constructively address the components of the reviewed team's report.
