...
::: callout-note
You will start working on this milestone in lab, but you will need to finish it outside of lab.
Before the end of lab, make sure you have at least one team meeting scheduled to continue working on this milestone.
:::
...
If you have your hearts set on a dataset that has fewer observations or variables than what's suggested here, that might still be ok; use these numbers as guidance for a successful proposal, not as minimum requirements.
...
Your research question should contain at least three variables, and should be a mix of categorical and numerical variables.
...
-   A well formulated research question.
    (You may include more than one research question if you want to receive feedback on different ideas for your project. However, one per dataset is required.)
...
-   Use the `glimpse()` function to provide a glimpse of the dataset.
-   State the number of observations and variables in the dataset. 
-   Describe the variables that are most relevant to your proposed analysis (include at least 6 relevant variables).
