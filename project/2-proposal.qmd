...
If you have your hearts set on a dataset that has fewer observations or variables than what's suggested here, that might still be okay; use these numbers as guidance for a successful proposal, not as minimum requirements.
...
Your research question should involve at least three variables, including a mix of categorical and numerical variables.
...
-   **Does not meet expectations (no credit)**: Major elements are missing.
