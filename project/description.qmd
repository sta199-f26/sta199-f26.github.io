...
The goal is not to do an exhaustive data analysis i.e., do not calculate every statistic and procedure you have learned for every variable, but rather let me know that you are proficient at asking meaningful questions and answering them with results of exploratory data analysis, that you are proficient in using R, and that you are proficient at interpreting and presenting the results.
...
You should employ methods we learned in the first half of the course, up til and including Week 8 (i.e., excluding modeling and inference).
...
2.  Milestone 2 - Proposal with two dataset ideas
3.  Milestone 3 - Improvement + progress I: from proposal to project
4.  Milestone 4 - Peer review another team's project
5.  Milestone 5 - Improvement + progress II: polishing the project
6.  Milestone 6 - Presentation with slides
7.  Milestone 7 - Reproducible project write-up of your analysis
...
## Milestone 3 - Improvement + progress I {#improvement-progress-I}

Instructions and grading criteria for this milestone are outlined in [Milestone 3: Improvement + progress I](/project/3-improvement-progress-I.html).
...
## Milestone 5 - Improvement + progress II {#improvement-progress-II}

Instructions and grading criteria for this milestone are outlined in [Milestone 5: Improvement + progress II](/project/5-improvement-progress-II.html).
...
| **M5: Improvement + progress II**  | 5 pts   |
| **M6: Slides + presentation**      | 25 pts  |
| **M7: Write-up**                   | 30 pts  |
