...
You should employ methods we learned in the first half of the course, up to and including Week 8 (i.e., excluding modeling and inference).
There is no limit on the tools or packages you may use, but you must stick to packages we learned in the course.
...
All written work (with the exception of presentation slides) should be reproducible, and the GitHub repo should be neatly organized.
...
The repo should be neatly organized as described above, contain no extraneous files, and have an easily readable README.
...
If you are suggesting that an individual did less than half the expected contribution given your team size (e.g., for a team of four students, if a student contributed less than 15% of the total effort), please provide some explanation.
...
| **M2: Proposal**                   | 10 pts  |
| **M3: Improvement and progress I** | 5 pts   |
| **M4: Peer review**                | 5 pts   |
| **M5: Improvement and progress II**| 5 pts   |
| **M6: Presentation**               | 25 pts  |
| **M7: Write-up**                   | 30 pts  |
