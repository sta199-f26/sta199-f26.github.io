...
::: source-control
Do not forget to preview, commit, and push regularly, after each substantial change to your document (e.g., after answering each question).
...
::: callout-warning
You'll need the pivoted data frame from this question again in Question 6, so make sure to give it an informative name and hold onto it.
:::
