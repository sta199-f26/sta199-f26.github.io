...
9.  Output displays the first ten rows of the picks data frame.
    - Note for items 8–9: Direct tibble display, `print(n = 10)`, `slice_head(n = 10)`, or an equivalent approach is acceptable.
...
2.  Part a. Output displays the first ten rows of each data frame.
    - Note for parts a–b: Direct tibble display, `print(n = 10)`, `head(10)`, `slice_head(n = 10)`, or an equivalent approach is acceptable.
