...
- Create and transform data using `dplyr`
- Build on your mastery of data visualizations using `ggplot2`
- Continue to gain practice with
...
For the remaining questions on the homework, you will again use data on counties in North Carolina that you used in HW 1.
...
Then, answer your question with an appropriate data visualization and/or data transformation pipeline and a brief description of your findings. Do not submit a visualization or data transformation that is identical to one already used in this homework.
