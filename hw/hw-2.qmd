...
By now you are also familiar with how to get feedback from AI.

<details>
<summary>Click to expand if you need a refresher on getting feedback from AI.</summary>
...
::: callout-warning
Before you wrap up the assignment, make sure that you preview, commit, and push one final time so that the final versions of both your `.qmd` file and the rendered PDF are pushed to GitHub and your Git pane is empty.
