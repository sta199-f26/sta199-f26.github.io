...
<!-- mtk: should this section be changed to sign into your github account (with a callout of creating it with these details in case they havne't already done so) -->
...
Paste the code (e.g., control-v on PC; command-v on Mac; or select *Edit*, then *Paste*) into the GitHub screen, and click *Continue*.

Now authorize access between Positron and GitHub by selecting the green **Authorize Visual-Studio-Code** button. You may need to sign in again to *Confirm access*.

<!-- mtk: this second sign in only seemed to happen the first time i did it. -->
...
<!-- mtk: the first time I did this it took a minute or so to install tinytex. -->
