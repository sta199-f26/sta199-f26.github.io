...
a.  What does the following pipeline do? Run it, analyze the result, and articulate in words what `arrange()` does.
...
b.  What does the following pipeline do? Run it, analyze the result, and articulate in words what `group_by()` does.
